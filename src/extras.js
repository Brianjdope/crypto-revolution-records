...
const FAQS = [
  {
    ...
    a: "The first AI-powered music creator label built on blockchain, co-founded by OZ The Crypto Goat. Every release is minted on-chain, every royalty is split by smart contract, and every fan can hold a piece of the label — with governance-backed voting rights — through the $CR token.",
  },
  {
    q: "Is $CR a security?",
