...
const FAQS = [
  {
    ...
    a: "The first AI-powered music creator label built on blockchain, founded by OZ The Crypto Goat. Every release is minted on-chain with governance-backed voting rights through the $CR token.",
  },
  {
    q: "Is $CR a security?",
    a: "$CR is a utility token granting access to drops, governance, and whitelisting to RWA tokens. We are not making investment claims and recommend you consult counsel in your jurisdiction before participating.",
  },
  {
    q: "How are artists paid?",
    a: "On-chain. Revenue is strictly through Audius and their rights to their music for the artist, the label, and $CR holders, the moment they settle.",
  },
  {
  ...
  },
  {
    ...
    a: "Everywhere and nowhere. Operating entity: Oz The Crypto Goat CryptoGoat.LLC (California, USA).",
  },
];
...
function buildSocials() {
  ...
  document.querySelectorAll("#socials, #hero-socials").forEach((el) => {
